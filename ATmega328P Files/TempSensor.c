...
int main(void) {
    ...
    // Set PB5 (digital pin 13 on Arduino Nano) as output for debugging
    DDRB |= (1 << PB5);
    ...
    while (1) {
        // Wait until TWINT is set (meaning we've been addressed or sent a byte)sd
